...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!supabase) {
      setStatus("error");
      setErrorMessage(
        "Contact form is temporarily unavailable. Please email hello@yourname.com directly."
      );
      setTimeout(() => {
        setStatus("idle");
        setErrorMessage("");
            ...
            <div className="space-y-8">
                ...
                {[
                  {
                    ...
                    title: "Email",
                    value: "sevanderr.io@gmail.com",
                    link: "mailto:sevanderr.io@gmail.com",
                  },
                  {
              ...
              <div className="p-8 bg-gradient-to-br from-cyan-950/20 to-blue-950/20 border border-cyan-400/30">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  ...
                  established company seeking to revamp your platform, I'd love
